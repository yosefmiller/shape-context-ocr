...
%==========================================================================
    function Initialize(varargin)
        ...
        % UserData should not be an object. Starting with R2014a, UserData
        % may be defined as a Graphics Object when the parent figure was
        % created with GUIDE. If it is, and is empty so not being used, then  
        % change it to an ordinary data structure (SEM, 1/4/16).
...
%==========================================================================
    function SetFigureName()
        % SEM commenting out this function: this is annoying! 12/29/15
...
%==========================================================================
    function tf = IsZoomMouseAllowed()
        ...
        [wcx, wcy] = GetCursorCoordOnWindow(get(hFig,'units'));
